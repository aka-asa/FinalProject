...
//                    if (j == 0)
//                    {
//                        for (int i = 0; i < strings.length; i+=9)
//                        {
...
//                            int i=0 ;
//                            for (; i<Integer.parseInt(strings[l+8]) ; i++)
//                            {
//                                passengerModel.getTickets().add(TicketModel.getTickets().get(TicketController.search(Integer.parseInt(strings[l+8+i+1]))));
//                            }
//                            PassengerModel.getPassengers().add(passengerModel);
//                            PassengerModel.setIdGenerator(PassengerModel.getIdGenerator()-1);
//                            l += (Integer.parseInt(strings[l+8])+9);
//                        }
//                    }
//                    if (j == 6)
//                    {
...
//            }
//            for (int i=0 ; i<PassengerModel.getPassengers().get(i).getTickets().size() ; i++)
//            {
//                string = string+TicketModel.getTickets().get(i).getId()+" ";
//            }
//            string = string.trim();
//            bufferedWriter.write(string);
//            string = "";
